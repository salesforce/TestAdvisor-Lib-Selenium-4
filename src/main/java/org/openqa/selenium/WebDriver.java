...
public interface WebDriver extends SearchContext {
	 ...
	 * POST operation, and the method will block until the load is complete (with
	 * the default 'page load strategy'. This will follow redirects issued either by
	 * the server or as a meta-redirect from within the returned HTML. Should a
	 ...
	 * executing the results of future calls against this interface will be against
	 * the freshly loaded page. Synonym for
	 * {@link org.openqa.selenium.WebDriver.Navigation#to(String)}.
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#navigate-to">W3C WebDriver
	 ...
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#get-current-url">W3C WebDriver
	 * specification</a> for more details.
	 *
	 ...
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#get-title">W3C WebDriver
	 * specification</a> for more details.
	 *
	 ...
	 * <p>
	 * This method differs from the official one by allowing objects extending
	 * WebElement.
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#find-elements">W3C WebDriver
	 * specification</a> for more details.
	 *
	 ...
	 * WebElement.
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#find-element">W3C WebDriver
	 * specification</a> for more details.
	 *
	 * @param <T> WebElement or any type extending WebElement to support customized
	 *            WebElement classes
	 ...
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#get-page-source">W3C WebDriver
	 * specification</a> for more details.
	 *
	 ...
	 * currently open.
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#close-window">W3C WebDriver
	 * specification</a> for more details.
	 */
	void close();
	 ...
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#get-window-handles">W3C
	 ...
	 * date
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#get-window-handle">W3C
	 * WebDriver specification</a> for more details.
	 *
	...
	interface Options {
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#add-cookie">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#delete-cookie">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#delete-all-cookies">W3C
		 * WebDriver specification</a> for more details.
		 */
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#get-all-cookies">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#get-named-cookie">W3C WebDriver
		 * specification</a> for more details.
		 *
	 ...
	 * <p>
	 * See <a href="https://w3c.github.io/webdriver/#set-timeouts">W3C WebDriver
	 * specification</a> for more details.
	 */
	interface Timeouts {
		 ...
		 *             <p>
		 *             When searching for a single element, the driver should poll the
		 *             page until the element has been found, or this timeout expires
		 *             before throwing a {@link NoSuchElementException}. When searching
		 *             for multiple elements, the driver should poll the page until at
		 ...
		 *             as it will have an adverse effect on test run time, especially
		 *             when used with slower location strategies like XPath.
		 *             <p>
		 *             If the timeout is negative, not null, or greater than 2e16 - 1,
		 *             an error code with invalid argument will be returned.
		 *
		...
		/**
		 * Gets the amount of time the driver should wait when searching for an element
		 * if it is not immediately present.
		 *
		 * @return The amount of time the driver should wait when searching for an
		 *         element.
		 * @see <a href="https://www.w3.org/TR/webdriver/#get-timeouts">W3C
		 *      WebDriver</a>
		 */
		 ...
		 *             negative, not null, or greater than 2e16 - 1, an error code with
		 ...
		 * @see <a href="https://www.w3.org/TR/webdriver/#set-timeouts">W3C
		 *      WebDriver</a>
		 * @see <a href=
		 *      "https://www.w3.org/TR/webdriver/#dfn-timeouts-configuration">W3C
		 *      WebDriver</a>
		 */
		@Deprecated
		 ...
		 * greater than 2e16 - 1, an error code with invalid argument will be returned.
		 *
		 * @return The amount of time to wait for an asynchronous script to finish
		 *         execution.
		 * @see <a href="https://www.w3.org/TR/webdriver/#get-timeouts">W3C
		 *      WebDriver</a>
		 * @see <a href=
		 ...
		 *             before throwing an error. If the timeout is negative, not null,
		 *             or greater than 2e16 - 1, an error code with invalid argument
		 *             will be returned.
		 */
		@Deprecated
		...
		/**
		 * Gets the amount of time to wait for a page load to complete before throwing
		 * an error. If the timeout is negative, not null, or greater than 2e16 - 1, an
		 * error code with invalid argument will be returned.
		 *
	...
	interface TargetLocator {
		 ...
		 * frame.
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#switch-to-frame">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#switch-to-parent-frame">W3C
		 * WebDriver specification</a> for more details.
		 *
		 ...
		 * given name/handle.
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#switch-to-window">W3C WebDriver
		 * specification</a> for more details.
		 *
		...
		/**
		 * Creates a new browser window and switches the focus for future commands of
		 * this driver to the new window.
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#new-window">W3C WebDriver
		 * specification</a> for more details.
		 *
		 * @param typeHint The type of new browser window to be created. The created
		 *                 window is not guaranteed to be of the requested type; if the
		 *                 driver does not support the requested type, a new browser
		 *                 window will be created of whatever type the driver does
		 *                 support.
		 * @return This driver focused on the given window
		 */
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#get-active-element">W3C
		 * WebDriver specification</a> for more details.
		 *
		 * @param <T> WebElement or any type extending WebElement to support customized
		 *            WebElement classes
		 ...
		 */
		<T extends WebElement> T activeElement();
	...
	interface Navigation {
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#back">W3C WebDriver
		 * specification</a> for more details.
		 */
		void back();
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#forward">W3C WebDriver
		 * specification</a> for more details.
		 */
		void forward();
		...
		/**
		 * Load a new web page in the current browser window. This is done using an HTTP
		 * POST operation, and the method will block until the load is complete. This
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#refresh">W3C WebDriver
		 * specification</a> for more details.
		 */
		void refresh();
	}
	...
	interface Window {
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#get-window-rect">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#set-window-rect">W3C WebDriver
		 * specification</a> for more details.
		 *
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#maximize-window">W3C WebDriver
		 * specification</a> for more details.
		 */
		void maximize();
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#minimize-window">W3C WebDriver
		 * specification</a> for more details.
		 */
		void minimize();
		 ...
		 * <p>
		 * See <a href="https://w3c.github.io/webdriver/#fullscreen-window">W3C
		 * WebDriver specification</a> for more details.
		 */
		void fullscreen();
	}
