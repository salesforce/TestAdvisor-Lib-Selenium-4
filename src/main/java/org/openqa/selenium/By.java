...
public abstract class By {
	 ...
	 * name should be used. If an element has multiple classes, please use
	 * {@link By#cssSelector(String)}.
	 *
	...
	public static class ById extends PreW3CLocator {
		...
		public ById(String id) {
			super("id", Require.argument("Id", id).nonNull("Cannot find elements when id is null."), "#%s");
	...
	public static class ByLinkText extends BaseW3CLocator {
		...
		public ByLinkText(String linkText) {
			super("link text", Require.argument("Link text", linkText)
	...
	public static class ByPartialLinkText extends BaseW3CLocator {
		...
		public ByPartialLinkText(String partialLinkText) {
			super("partial link text", Require.argument("Partial link text", partialLinkText)
					.nonNull("Cannot find elements when the link text is null."));
	...
	public static class ByName extends PreW3CLocator {
		...
		public ByName(String name) {
			super("name", Require.argument("Name", name).nonNull("Cannot find elements when name text is null."),
	...
	public static class ByTagName extends BaseW3CLocator {
		...
		public ByTagName(String tagName) {
			super("tag name",
					Require.argument("Tag name", tagName).nonNull("Cannot find elements when the tag name is null."));
	...
	public static class ByXPath extends BaseW3CLocator {
		...
		public ByXPath(String xpathExpression) {
			super("xpath",
					Require.argument("XPath", xpathExpression).nonNull("Cannot find elements when the XPath is null."));
	...
	public static class ByClassName extends PreW3CLocator {
		...
		public ByClassName(String className) {
			super("class", Require.argument("Class name", className)
					.nonNull("Cannot find elements when the class name expression is null."), ".%s");
	...
	public static class ByCssSelector extends BaseW3CLocator {
		...
		public ByCssSelector(String cssSelector) {
			super("css selector", Require.argument("CSS selector", cssSelector)
