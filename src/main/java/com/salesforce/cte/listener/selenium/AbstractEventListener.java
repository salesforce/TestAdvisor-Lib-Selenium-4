...
public abstract class AbstractEventListener implements IEventListener {
	...
	@Override
	public void afterGetDomProperty(WebDriverEvent event, String value, String name, WebElement element) {
	}
	...
	@Override
	public void afterGetDomAttribute(WebDriverEvent event, String value, String name, WebElement element) {
	}
	...
	@Override
	public void afterGetAriaRole(WebDriverEvent event, String role, WebElement element) {
	}
	...
	@Override
	public void afterGetAccessibleName(WebDriverEvent event, String name, WebElement element) {
	}
	...
	protected TestEvent createTestEvent(TestEventType eventType, WebDriverEvent event, Level eventLevel){
        ...
        return new TestEvent(eventType, event.toString(), 
							eventLevel.toString(),
							cmd, 
							param1 + param2, 
							locator,
